...
export async function deleteBill(itemId, path){
...
export  async function editBill(potId, formData, path){
    if (!potId) {
...
export async function createNewBill(newData,path){
...
export async function getBillsByUserID(userId, path){
    if (!userId) {
